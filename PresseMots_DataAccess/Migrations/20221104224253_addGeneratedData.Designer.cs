...
namespace PresseMots_DataAccess.Migrations
{
    ...
    [Migration("20221104224253_addGeneratedData")]
    partial class addGeneratedData
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PresseMots_DataModels.Entities.Like", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            StoryId = 1,
                            SubmittedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserId = 2
                        });
                });
            ...
            modelBuilder.Entity("PresseMots_DataModels.Entities.StoryTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PresseMots_DataModels.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PresseMots_DataModels.Entities.StoryTag", b =>
                {
                    ...
                    b.HasOne("PresseMots_DataModels.Entities.Tag", "Tag")
                        .WithMany("StoryTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
